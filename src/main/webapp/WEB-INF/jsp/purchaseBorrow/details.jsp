            ...
            <div class="col-xl-12">
                <div class="card custom-card">
                    <div class="card-header justify-content-between">
                       ...
                       <button onclick="redirectToBillHistory(${bill.id})" class="btn btn-primary btn-sm">History</button>

                        <button class="btn btn-primary btn-sm" onclick="toggleEditMode()">Edit</button>
                        </div>
                    </div>
                    <form action="/purchaseborrow/update" method="POST" onsubmit="return validateForm()">
                        <div class="card-body">
                            <!-- Profile Section -->
                            <div class="profile">
                                <h5>
                                ...
                                <input type="hidden" name="id" value="${bill.supplierId.id}">
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                            ...
                                            <div class="form-group d-flex align-items-center">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="cash_Payment" id="cashPayment"
                                                        class="form-control d-none edit-mode" value="${isEditMode ? 0 : bill.cashPayment}"
                            ...
                            <div class="card-footer text-right">
                                ...
                                <a href="javascript:window.history.back();" class="btn btn-danger btn-sm">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
...
function redirectToBillHistory(billId) {
    window.location.href = '/purchaseborrow/bill_History?id=' + billId;
}
</script>
