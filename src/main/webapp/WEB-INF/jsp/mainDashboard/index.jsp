					...
					<div class="card-body">
						<div class="d-flex align-items-center justify-content-between">
							<div class="d-flex align-items-center">
								<span class="avatar bg-primary-transparent"> <svg
										class="fill-secondary" style="height: 30px;"
								...
								<h6 class="mb-0 text-default fw-medium ms-3 fs-18">Expires
									Products</h6>
							</div>
						</div>
						<div
							...
							<div>
								<h2 class="text-default mb-0 fs-24 fw-semibold">Total:
									${count}</h2>
			...
			<div class="col-xxl-3 col-lg-6 col-md-6">
				<div class="card custom-card overflow-hidden">
					<div class="card-body">
						<div class="d-flex align-items-center justify-content-between">
							<div class="d-flex align-items-center">
								<span class="avatar   bg-secondary-transparent"> <svg
										class="fill-secondary" style="height: 30px;"
										xmlns="http://www.w3.org/2000/svg"
										enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                                                            <path
								...
								<h6 class="mb-0 text-default fw-medium ms-3 fs-18">Less
									Stock</h6>
							</div>
						...
						<div
							class="mt-2 d-flex align-items-center justify-content-between">
							<div>
								<h2 class="text-default mb-0 fs-24 fw-semibold">Stock:
									${countStockLessThanTwo}</h2>
			...
			<div class="col-xxl-3 col-lg-6 col-md-6">
				<div class="card custom-card overflow-hidden bg-faint-red">
					<div class="card-body">
						<div class="d-flex align-items-center justify-content-between">
							<div class="d-flex align-items-center">
								<span class="avatar   bg-warning-transparent"> <svg
										class="fill-warning" style="height: 30px;"
										xmlns="http://www.w3.org/2000/svg"
										enable-background="new 0 0 24 24" viewBox="0 0 24 24"
										id="shopping-bag">
                                                            <path
											class="fill-warning" fill="#4B5563"
								...
								<h6 class="mb-0 text-default fw-medium ms-3 fs-18">Expired
									Products</h6>
							</div>
			...
			<div class="col-xxl-3 col-lg-6 col-md-6">
				<div class="card custom-card overflow-hidden">
					<div class="card-body">
						<div class="d-flex align-items-center justify-content-between">
							<div class="d-flex align-items-center">
								<span class="avatar bg-success-transparent"> <svg
										class="fill-success" style="height: 30px;"
										xmlns="http://www.w3.org/2000/svg"
										enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                            <path class="fill-success"
								...
								<h6 class="mb-0 text-default fw-medium ms-3 fs-18">Bill
									Paid Today</h6>
							</div>
					...
					<div class="card-body">
						<div class="d-flex align-items-center justify-content-between">
                            ...
                            <path class="fill-success"
								...
								<h6 class="mb-0 text-default fw-medium ms-3 fs-18">Remaining
									Amount</h6>
							</div>
						</div>
						<div
					...
					<div class="card-body">
						<div class="d-flex align-items-center justify-content-between">
                            ...
                            <path class="fill-success"
								...
								<h6 class="mb-0 text-default fw-medium ms-3 fs-18">Supplier  Amount</h6>
							</div>
						</div>
						<div
							class="mt-2 d-flex align-items-center justify-content-between">
					...
					<div class="card-body">
						<div class="d-flex align-items-center justify-content-between">
                            ...
                            <path class="fill-success"
								...
								<h6 class="mb-0 text-default fw-medium ms-3 fs-18">Supplier Payable Amount</h6>
							</div>
						</div>
						<div
							class="mt-2 d-flex align-items-center justify-content-between">
        ...
        <div class="card-body">
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                    ...
                    <h6 class="mb-0 text-default fw-medium ms-3 fs-18">Supplier Paid Today</h6>
                </div>
            ...
            <div class="mt-2">
                <h2 class="text-default mb-0 fs-24 fw-semibold">${countSuppliersPaidToday}</h2>
                <p class="mb-0 text-muted">Supplier Paid Today</p>
            </div>
            <div class="mt-2">
                <button id="btnSupplierRemainingPayments" data-bs-toggle="modal" data-bs-target="#supplierRemainingPaymentsModal" class="btn btn-primary btn-sm">Details</button>
            </div>
			...
			<div class="modal-body">
				<div class="input-group">
					<a href="javascript:void(0);"
						class="input-group-text border-0 bg-transparent" id="Search-Grid"><i
						class="ri ri-search-2-line header-link-icon fs-14"></i></a> <input
						type="search" class="form-control form-control-sm border-0 px-2"
						placeholder="Search" aria-label="Username"> <a
						href="javascript:void(0);"
						class="input-group-text border-0 bg-transparent" id="voice-search"><i
						class="ri ri-mic-2-line  header-link-icon"></i></a> <a
						href="javascript:void(0);"
						class="btn btn-light btn-icon border-0 bg-transparent"
						data-bs-toggle="dropdown" aria-expanded="false"> <i
						class="ri ri-more-2-line"></i>
					</a>
				...
				<div class="mt-4">
					...
					<span class="search-tags"><i class="ri ri-user-line me-2"></i>Team<a
						href="javascript:void(0)"
						class="tag-addon bg-transparent header-remove-btn"><i
							class="fe fe-x"></i></a></span> <span class="search-tags"><i
						class="ri ri-file-text-line me-2"></i>Forms<a
						href="javascript:void(0)"
						class="tag-addon bg-transparent header-remove-btn"><i
							class="fe fe-x"></i></a></span> <span class="search-tags"><i
						class="ri ri-map-pin-line me-2"></i>Maps<a
						href="javascript:void(0)"
						class="tag-addon bg-transparent header-remove-btn"><i
							class="fe fe-x"></i></a></span> <span class="search-tags"><i
						class="ri ri-server-line me-2"></i>Widgets<a
						href="javascript:void(0)"
						class="tag-addon bg-transparent header-remove-btn"><i
				...
				<div class="my-4">
					...
					<div
						...
						<a href="mail-inbox.html"><span>Mail</span></a> <a
							class="ms-auto lh-1" href="javascript:void(0);"
							data-bs-dismiss="alert" aria-label="Close"><i
							class="fe fe-x text-muted"></i></a>
					</div>
	...
	$(document)
			.ready(
					function() {
						...
						$(
								'.btn-primary[data-bs-toggle="modal"][data-bs-target="#productPopup"]')
								.click(function() {
						...
						$(
								'#btnStockLessThanTwo[data-bs-toggle="modal"][data-bs-target="#stockLessThanTwoModal"]')
								.click(function() {
						...
						$(
								'#btnExpiredProducts[data-bs-toggle="modal"][data-bs-target="#expiredProductsPopup"]')
								.click(function() {
						...
						$(
								'#showCustomersPaidToday[data-bs-toggle="modal"][data-bs-target="#customerBillsPaidTodayModal"]')
								.click(
										function() {
											$('#customerBillsPaidTodayModal')
													.modal('show'); // Show the modal with id customerBillsPaidTodayModal when the button is clicked
										});

						$(
								'#btnRemainingPayments[data-bs-toggle="modal"][data-bs-target="#remainingPaymentsModal"]')
								.click(function() {
									$('#remainingPaymentsModal').modal('show'); // Show the modal with id remainingPaymentsModal when the button is clicked
								});
						
						
						 $('#btnSupplierRemainingPayments[data-bs-toggle="modal"][data-bs-target="#supplierRemainingPaymentsModal"]').click(function() {
						        $('#supplierRemainingPaymentsModal').modal('show'); // Show the modal with id supplierRemainingPaymentsModal when the button is clicked
						    });
						 
						 $('#btnSupplierPaidToday[data-bs-toggle="modal"][data-bs-target="#supplierPaidTodayModal"]').click(function() {
						        $('#supplierPaidTodayModal').modal('show'); // Show the modal with id supplierPaidTodayModal when the button is clicked
						    });
					});
</script>
