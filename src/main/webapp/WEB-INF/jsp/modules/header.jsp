					...
					<ul class="main-menu">
						...
						<li class="slide has-sub"><a href="javascript:void(0);"
							...
							<ul class="slide-menu child1">
								...
								<li class="slide"><a href="allProd" class="side-menu__item">All
										Product</a></li>
							</ul></li>

						<!-- Start::slide -->
						<li class="slide has-sub"><a href="addCompanyForm"
							class="side-menu__item"> <i
								class="ri-inbox-line side-menu__icon"></i> <span
								class="side-menu__label">Add Company</span>
						</a></li>
						<li class="slide has-sub"><a href="all_Data"
							class="side-menu__item"> <i
								class="ri-inbox-line side-menu__icon"></i> <span
						...
						<li class="slide has-sub"><a href="allProd"
							class="side-menu__item"> <i
								class="ri-inbox-line side-menu__icon"></i> <span
